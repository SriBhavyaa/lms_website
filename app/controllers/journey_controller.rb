class JourneyController < ApplicationController
    ...
    def show
      ...
      render json: journey.as_json(include: { stages: { include: { activities: {} }}})
    end
    ...
    def create_activities(stage, activities_params)
      activities_params.each do |activity_params|
        activity = stage.activities.new(activity_params.permit(:name, :activity_type).merge(stage_id: stage.id))
